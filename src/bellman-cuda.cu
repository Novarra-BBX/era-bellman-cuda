...
bc_error grumpkin_msm_set_up() { return static_cast<bc_error>(msm_grumpkin::set_up()); }

bc_error grumpkin_msm_execute_async(const msm_configuration configuration) {
  msm_grumpkin::execution_configuration cfg = {static_cast<cudaMemPool_t>(configuration.mem_pool.handle),
                                               static_cast<cudaStream_t>(configuration.stream.handle),
                                               static_cast<msm_grumpkin::point_affine *>(configuration.bases),
                                               static_cast<fd_p::storage *>(configuration.scalars),
                                               static_cast<msm_grumpkin::point_jacobian *>(configuration.results),
                                               configuration.log_scalars_count,
                                               static_cast<cudaEvent_t>(configuration.h2d_copy_finished.handle),
                                               configuration.h2d_copy_finished_callback,
                                               configuration.h2d_copy_finished_callback_data,
                                               ...
                                               configuration.d2h_copy_finished_callback,
                                               configuration.d2h_copy_finished_callback_data};
  return static_cast<bc_error>(msm_grumpkin::execute_async(cfg));
}

bc_error grumpkin_msm_tear_down() { return static_cast<bc_error>(msm_grumpkin::tear_down()); }
