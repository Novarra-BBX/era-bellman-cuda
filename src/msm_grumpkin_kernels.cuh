...
// Grumpkin G1 MSM kernels.
// Grumpkin: y^2 = x^3 - 17 over Fq = BN254 Fr (fd_q).
// Scalar field = Grumpkin Fr = BN254 Fq (fd_p).
namespace msm_grumpkin {

typedef ec<fd_q, 17, true> curve;  // ec<fd_q, |B|=17, B_NEG=true>
...
__host__ cudaError_t compute_bucket_indexes(const fd_p::storage *scalars, unsigned windows_count, unsigned window_bits, unsigned *bucket_indexes,
