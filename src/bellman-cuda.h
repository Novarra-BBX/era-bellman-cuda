...
// Grumpkin G1 MSM (BN254 twist: bases in fd_q/BN254-Fr, scalars in fd_p/BN254-Fq)
bc_error grumpkin_msm_set_up();
bc_error grumpkin_msm_execute_async(msm_configuration configuration);
bc_error grumpkin_msm_tear_down();
