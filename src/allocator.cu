...
template struct allocation<msm_grumpkin::point_affine>;
template struct allocation<msm_grumpkin::point_projective>;
template struct allocation<msm_grumpkin::point_jacobian>;
template struct allocation<msm_grumpkin::point_xyzz>;

template cudaError_t allocate<msm_grumpkin::point_affine>(allocation<msm_grumpkin::point_affine> &allocation, const size_t size, cudaMemPool_t pool, cudaStream_t stream);
template cudaError_t free<msm_grumpkin::point_affine>(allocation<msm_grumpkin::point_affine> &allocation, cudaStream_t stream);

template cudaError_t allocate<msm_grumpkin::point_projective>(allocation<msm_grumpkin::point_projective> &allocation, const size_t size, cudaMemPool_t pool, cudaStream_t stream);
template cudaError_t free<msm_grumpkin::point_projective>(allocation<msm_grumpkin::point_projective> &allocation, cudaStream_t stream);

template cudaError_t allocate<msm_grumpkin::point_jacobian>(allocation<msm_grumpkin::point_jacobian> &allocation, const size_t size, cudaMemPool_t pool, cudaStream_t stream);
template cudaError_t free<msm_grumpkin::point_jacobian>(allocation<msm_grumpkin::point_jacobian> &allocation, cudaStream_t stream);

template cudaError_t allocate<msm_grumpkin::point_xyzz>(allocation<msm_grumpkin::point_xyzz> &allocation, const size_t size, cudaMemPool_t pool, cudaStream_t stream);
template cudaError_t free<msm_grumpkin::point_xyzz>(allocation<msm_grumpkin::point_xyzz> &allocation, cudaStream_t stream);
